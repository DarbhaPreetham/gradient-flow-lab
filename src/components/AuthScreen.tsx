  ...
  return (
    <main className="radial-bg flex min-h-dvh items-center justify-center px-5 py-10">
      <div className="glass-panel w-full max-w-md rounded-3xl p-7">
        ...
        {mode !== "forgot" && (
          ...
          >
            <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
              ...
              <path
                fill="#4CAF50"
                d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29 35.5 26.6 36.5 24 36.5c-5.2 0-9.6-3.3-11.2-8l-6.5 5C9.6 39.6 16.2 44 24 44z"
              />
              <path
                fill="#1976D2"
                d="M43.6 20.5H42V20H24v8h11.3c-.8 2.4-2.3 4.5-4.2 6l6.2 5.2C41 36 44 30.5 44 24c0-1.3-.1-2.4-.4-3.5z"
              />
            </svg>
        ...
        {mode !== "forgot" && (
          <div
            className="my-5 flex items-center gap-3 text-[10px] uppercase tracking-[0.3em]"
            style={{ color: "var(--cw-muted-soft)" }}
          >
        ...
        <div
          className="mt-5 flex flex-col items-center gap-2 text-xs"
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label className="block">
      <span
        className="font-display mb-1 block text-[10px] font-semibold uppercase tracking-[0.2em]"
        style={{ color: "var(--cw-muted)" }}
      >
        {label}
      </span>
